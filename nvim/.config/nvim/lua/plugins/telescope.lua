...
return { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>sF", function() builtin.find_files({ no_ignore = true, hidden = true }) end, { desc = "[S]earch [F]iles" })
        vim.keymap.set("n", "<leader>sg", function() builtin.live_grep({}) end, { desc = "[S]earch by [G]rep" })
        vim.keymap.set("n", "<leader>sG", function() builtin.live_grep({ additional_args = { "--no-ignore", "--hidden" } }) end, { desc = "[S]earch by [G]rep" })
        ...
        vim.keymap.set("v", "<leader>s", builtin.grep_string, { desc = "[S]earch current [W]ord" })
